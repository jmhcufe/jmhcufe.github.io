...
### 论文
3. 刘宇初, 崔海媛, 金鑫, **贾明华**. 开放科学视域下高校科研用户数字学术素养内涵、框架及图书馆培育策略研究[J]. *图书馆学研究*, 已录用.（北大核心, CSSCI, AMI扩展）
4. **贾明华**, 季梵, 张元俊, 赵静茹. 用户需求视域下文献受赠管理平台研究与实践——以北京大学图书馆为例[J]. *图书馆杂志*, 已录用.（北大核心, CSSCI, AMI核心）
